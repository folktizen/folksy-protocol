...
contract StrategyTest is Test {
    ...
    function test_Create_Strategy() public {
        ...
        IFolksyStrategy.Step[] memory steps = new IFolksyStrategy.Step[](3);
    ...
    //     IFolksyStrategy.Strategy[] memory sp = strategy.getStrategy(address(0xAAAA));
    // }
}
