...
library AerodromeUtils {
  ...
  function balanceTokenRatio(
    ...
    routes[0] = IRouter.Route(
      sellTokenA ? tokenA : tokenB, sellTokenA ? tokenB : tokenA, stable, IRouter(AERODROME_ROUTER).defaultFactory()
    );
  ...
  function quoteDepositLiquidity(
    ...
    (amountAOut, amountBOut) = aerodromeRouter.quoteRemoveLiquidity(tokenA, tokenB, stable, factory, liquidityDeposited);
  }
